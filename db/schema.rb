...
ActiveRecord::Schema[7.2].define(version: 2026_05_25_093000) do
  ...
  create_table "comment_posts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "inbox_id", "last_comment_at"], name: "idx_comment_posts_last_comment"
    t.index ["account_id", "inbox_id", "post_created_at"], name: "idx_comment_posts_post_date"
    t.index ["account_id", "post_id"], name: "index_comment_posts_on_account_id_and_post_id", unique: true
    t.index ["account_id"], name: "index_comment_posts_on_account_id"
    t.index ["inbox_id"], name: "index_comment_posts_on_inbox_id"
  end
  ...
  add_foreign_key "comment_posts", "accounts"
