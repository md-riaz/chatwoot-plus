  ...
  def app_config
    {
      ...
      OMNI_COMMENTS_PAGE_ENABLED: GlobalConfigService.load('OMNI_COMMENTS_PAGE_ENABLED', 'false'),
      OMNI_COMMENTS_PAGE_USER_IDS: GlobalConfigService.load('OMNI_COMMENTS_PAGE_USER_IDS', ''),
